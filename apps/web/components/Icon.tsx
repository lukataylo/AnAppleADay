// Google Material Design icons as inline SVG (filled, 24dp paths), so they work
// offline in the PWA with no web-font flash. Fill uses currentColor.
...
export function Icon({
  ...
  const d = PATHS[name] ?? PATHS.favorite;
  return (
    <svg
      width={size}
      height={size}
